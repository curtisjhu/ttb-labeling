      ...
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between py-32 px-16 sm:items-start">
        <div className="flex flex-col items-center gap-6 text-center sm:items-start sm:text-left">
          ...
          <p className="max-w-md text-lg leading-8 text-zinc-600 dark:text-zinc-400">
            Drag and drop a few (PNG, JPEG) less than 20 MB total or
            <label
              htmlFor="file-upload"
            ...
            <div className="mt-4 w-full flex flex-wrap gap-4">
              ...
              {isSending ? (
                <div className="flex items-center justify-center w-full mt-4">
                  ...
                  {status && <span className="ml-2 text-sm text-zinc-500">{status}</span>}
                </div>
              ) : (
              <button
                className="inline-flex font-medium cursor-pointer ml-2 h-12 items-center justify-center gap-2 rounded-full bg-foreground px-5 text-background transition-colors hover:bg-[#383838] dark:hover:bg-[#ccc] md:w-[158px]"
                style={{ verticalAlign: 'middle' }}
                onClick={handleSend}
              >
                Send Files
        ...
        <div className="mt-4 w-full">
          {apiResponse && (
            <div className="bg-zinc-100 dark:bg-zinc-900 p-4 rounded-lg border border-zinc-200 dark:border-zinc-700">
              <pre className="text-sm text-zinc-800 dark:text-zinc-200 whitespace-pre-wrap break-all">
